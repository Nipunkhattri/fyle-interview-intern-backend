...
from core.apis.assignments import student_assignments_resources, teacher_assignments_resources,principal_power
...
app.register_blueprint(principal_power,url_prefix='/principal')
